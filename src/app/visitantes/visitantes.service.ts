...
export class VisitantesService extends BaseService {
  ...
  getVisitantes(request: VisitanteFilterModel ): Observable<Array<Visitante>> {
    ...
    return this.http.get<Array<Visitante>>(environment.protocol + environment.urlCloud + environment.urlVisitanteMs + environment.filtro, {params: queryParams})
          .pipe(
  ...
  postVisitanteAmqp(visitante: Visitante): Observable<any>{
    ...
    return this.http.post<Visitante>(`${environment.protocol + environment.urlCloud}/sgc/visitante/amqp/novo`
  ...
  putVisitante(visitante: Visitante, id: string): Observable<any>{
    ...
    return this.http.put<Visitante>(`${environment.protocol + environment.urlCloud}/sgc/visitante/amqp/alterar?id=${id}`
        , JSON.stringify(visitante)
        , this.httpOptions)
        .pipe(
  ...
  postVisita<Visita>(visitaRequest: VisitaRequest): Observable<any>{
    ...
    return this.http.post<Visita>(`${environment.protocol + environment.urlCloud}/sgc/visita/novo`
