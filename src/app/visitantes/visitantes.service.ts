...
export class VisitantesService extends BaseService {
  ...
  getVisitantes(request: VisitanteFilterModel ): Observable<Array<Visitante>> {
    ...
    return this.http.get<Array<Visitante>>(environment.protocol + environment.urlCloud + environment.urlSgcBackend + environment.visitante + environment.filtro, {params: queryParams})
          .pipe(
  ...
  postVisitanteAmqp(visitante: Visitante): Observable<any>{
    ...
    return this.http.post<Visitante>(`${environment.protocol + environment.urlCloud + environment.urlSgcBackend}/visitante/amqp/novo`
  ...
  putVisitante(visitante: Visitante, id: string): Observable<any>{
    ...
    return this.http.put<Visitante>(`${environment.protocol + environment.urlCloud + environment.urlSgcBackend}/visitante/amqp/alterar?id=${id}`
        , JSON.stringify(visitante)
        , this.httpOptions)
        .pipe(
  ...
  postVisita<Visita>(visitaRequest: VisitaRequest): Observable<any>{
    ...
    return this.http.post<Visita>(`${environment.protocol + environment.urlCloud + environment.urlSgcBackend}/visita/novo`
  ...
  postVisitaAmqp<Visita>(visitaRequest: VisitaRequest): Observable<any>{
    ...
    return this.http.post<Visita>(`${environment.protocol + environment.urlCloud + environment.urlSgcBackend}/visita/amqp/novo`
        , JSON.stringify(visitaRequest)
        , this.httpOptions)
        .pipe(
          map(response => response['data'])
